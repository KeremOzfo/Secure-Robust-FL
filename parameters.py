...
def args_parser():
    ...
    parser.add_argument('--aggr', type=str, default='cc', help='robust Aggregators')
    ...
    # nn related
    parser.add_argument('--nn_name', type=str, default='mlp_small', help='simplecnn,simplecifar,VGGs resnet(8-9-18-20)')
